		...
		var dialog = self.createDialog({
			...
			yesBtn : {
				...
				click : function(e) {
					...
					var url = [checkbox[0].checked ? self.pluginsPath + 'baidumap/oldindex.html' : 'http://api.map.baidu.com/staticimage',
...
// Google Maps: http://code.google.com/apis/maps/oldindex.html
